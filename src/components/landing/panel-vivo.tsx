  ...
  return (
    <div className="rounded-xl border border-border bg-card shadow-lg">
      ...
      <div className="flex items-center justify-between border-b border-border px-5 py-3.5">
        <span className="flex items-center gap-2 tabular-nums text-xs font-semibold uppercase tracking-[0.15em] text-muted-foreground">
        ...
        <span className="tabular-nums text-base font-semibold tabular-nums text-foreground">
          {reloj}
        </span>
      </div>
      ...
      <div className="border-b border-border p-5">
        <div className="flex items-start justify-between gap-3">
          <span
            className={cn(
              ...
              abierto ? "bg-gold/15 text-gold" : "bg-muted text-muted-foreground",
            )}
          >
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2">
              ...
              <span
                className={cn(
                  "rounded-full px-2.5 py-0.5 tabular-nums text-xs font-semibold uppercase tracking-[0.1em]",
                  abierto
            ...
            <p className="mt-1.5 flex items-center gap-1.5 tabular-nums text-xs text-muted-foreground">
        ...
        <Link
          ...
          className={cn(
            ...
            abierto
              ? "bg-gold text-white hover:brightness-95 active:scale-[0.99]"
      ...
      <div className="border-b border-border p-5">
        <p className="tabular-nums text-xs font-semibold uppercase tracking-[0.15em] text-muted-foreground">
          {t("panelNextEvent")}
        </p>
        ...
        {evento && fechaEvento ? (
          <a href="#eventos" className="group mt-3 flex items-center gap-4">
            ...
            >
              <span className="tabular-nums text-xl font-semibold leading-none tabular-nums text-foreground">
                {new Intl.DateTimeFormat(locale, { day: "2-digit" }).format(fechaEvento)}
              </span>
              <span className="mt-0.5 tabular-nums text-[11px] font-semibold uppercase tracking-[0.1em] text-primary">
            ...
            <span className="min-w-0">
              ...
              {evento.ubicacion && (
                <span className="mt-1 flex items-center gap-1.5 tabular-nums text-xs text-muted-foreground">
      ...
      <div className="flex items-center gap-2.5 rounded-b-xl bg-muted/60 px-5 py-3.5">
        ...
        <p className="tabular-nums text-xs leading-snug text-muted-foreground">
          {t("panelInviteOnly")}
        </p>
      </div>
    </div>
